...
class TransformerCrossEncoderLayer(nn.Module):
    def __init__(self, args, embed_dim, num_heads=4, attn_dropout=0.1, relu_dropout=0.1, res_dropout=0.1, 
        ...
        if args.cross_method == 'moe':
            ...
            router_bias_mode=args.router_bias_mode,
            gate_normalization=args.gate_normalization,
            router_topk_mode=args.router_topk_mode,
            moe_mixing_space=args.moe_mixing_space,
            load_balance_mode=args.load_balance_mode,
            shared_experts=args.shared_experts,
            shared_expert_weight=args.shared_expert_weight,
            freeze_shared_ffn=args.freeze_shared_ffn,
            ...
            staged_shared_lora=args.staged_shared_lora,
            staged_shared_lora_warmup_epochs=args.staged_shared_lora_warmup_epochs,
            expert_orth_coef=args.expert_orth_coef,
            ...
            semantic_profile_embedding_source=args.semantic_profile_embedding_source,
            ...
            router_variance_coef=args.router_variance_coef,
            output_orth_coef=args.output_orth_coef,
            specialization_loss_mode=args.specialization_loss_mode,
            specialization_aux_coef=args.specialization_aux_coef,
